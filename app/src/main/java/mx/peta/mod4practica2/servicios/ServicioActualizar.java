 ...
 */
public class ServicioActualizar extends Service {
    ...
    public static final int    INTERVALOS_ESPERA    = 10;
    ...
    private class MyAsyncTask extends AsyncTask<Integer, Integer, Boolean> {
        ...
        protected void onPreExecute() {
            mNotif = new NotificationCompat
                    ...
                    .setContentTitle(getString(R.string.actualizando_aplicacion))
                    .setContentText(getString(R.string.actualizando) + " " + modelItem.appName)
        ...
        protected void onPostExecute(Boolean result) {
            if (result) {
                ...
                mNotif.setContentTitle(getString(R.string.actualizacion_completa));
                mNotif.setContentText(modelItem.appName);
                mNotif.setContentInfo(getString(R.string.actualizada));
                mNotif.setAutoCancel(true);
                mNotif.setStyle(new NotificationCompat.BigTextStyle()
                        .bigText(getString(R.string.actualizada_completa_largo) + " " + modelItem.appName));
